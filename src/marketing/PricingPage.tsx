      ...
      <section className="pt-32 pb-16 px-8 bg-white">
        <div className="max-w-7xl mx-auto text-center">
          ...
          <p className="text-lg text-text-muted max-w-3xl mx-auto">
            Choose the plan that fits your growth goals. All plans include human
            QA and enterprise-grade deliverability.
          </p>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="grid md:grid-cols-3 gap-8">
            ...
            <div className="bg-white rounded-2xl p-8 shadow-xl shadow-black/5 border border-border-light hover:scale-105 transition-transform duration-200">
              <div className="text-sm text-text-muted text-center mb-2 font-medium">
                Launch Fast
              </div>
              <h3 className="text-3xl font-semibold text-text-dark mb-4 text-center">
                BASE
              </h3>
              <div className="mb-6">
                <div className="text-4xl font-bold text-primary mb-1 text-center">
                  $397<span className="text-lg text-text-muted">/mo</span>
                </div>
                <p className="text-sm text-text-muted text-center italic">
                  One-time $500 setup — first payment $897
                </p>
              </div>
              <BookDemoButton
                eventLocation="pricing-base"
              ...
              <ul className="space-y-3">
                <li className="flex items-start gap-3">
                  ...
                  <span className="text-sm text-text-dark">
                    1 campaign (3-month minimum)
                  </span>
                </li>
                <li className="flex items-start gap-3">
                  <Check className="w-5 h-5 text-primary flex-shrink-0 mt-0.5" />
                  <span className="text-sm text-text-dark">
                    3 series strategic follow-ups
                  </span>
                </li>
                <li className="flex items-start gap-3">
                  <Check className="w-5 h-5 text-primary flex-shrink-0 mt-0.5" />
            ...
            <div className="bg-white rounded-2xl p-8 shadow-xl shadow-black/5 border-2 border-primary relative hover:scale-105 transition-transform duration-200">
              ...
              <div className="mb-6">
                <div className="text-4xl font-bold text-primary mb-1 text-center">
                  $797<span className="text-lg text-text-muted">/mo</span>
                </div>
                <p className="text-sm text-text-muted text-center italic">
                  One-time $700 setup — first payment $1,497
                </p>
              </div>
              <BookDemoButton
                eventLocation="pricing-assist"
            ...
            <div className="bg-white rounded-2xl p-8 shadow-xl shadow-black/5 border border-border-light hover:scale-105 transition-transform duration-200">
              ...
              <p className="text-base text-text-muted mb-8 text-center">
                For companies running multiple brands, regions, or offers that
                need a fully customized outbound system. Includes tailored
                strategy, advanced deliverability management, and ongoing
                optimization across campaigns.
              </p>
              <BookDemoButton
                eventLocation="pricing-enterprise"
      ...
      <section className="py-24 px-8 bg-primary">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-lg text-white/90 mb-8">
            Book a 15-minute call and we'll show you exactly how we'd build your
            campaign.
          </p>
          <BookDemoButton
            size="lg"
            eventLocation="pricing-cta"
